...
- [Lodash](https://lodash.com/docs/4.17.3)
...
## plugins + niche libraries

- [Bootbox](http://bootboxjs.com/)
- [FastClick](https://ftlabs.github.io/fastclick/)
- [ParallaxJS](http://pixelcog.github.io/parallax.js/)
- [Scrollorama](http://johnpolacek.github.io/scrollorama/)
- [Pin](https://github.com/webpop/jquery.pin)
...
- [links](https://tympanus.net/Development/CreativeLinkEffects/)
- [modals](https://tympanus.net/Development/ModalWindowEffects/)
- [progress buttons](https://tympanus.net/Development/ProgressButtonStyles/)